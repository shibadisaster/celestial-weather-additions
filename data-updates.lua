...
if true then
    ...
    if true then
        local carna_fog = table.deepcopy(fog)
    ...
    if true then
        ...
        local carna_weather_sparks = table.deepcopy(cluster_particles)
    ...
    if true then
        ...
        local carna_weather_sparks_large = table.deepcopy(cluster_particles)
    ...
    if true then
        ...
        local carna_weather_sparks_small = table.deepcopy(cluster_particles)
